  ...
  Timepicker.prototype = {
    ...
    hideWidget: function() {
      ...
      if(this.oldValue !== this.$element.val())
        this.$element.val(this.getTime()).change(); // BENNER - SMS 1438904
    },
    ...
    updateElement: function() {
      if(this.$element.attr('onchange') === undefined) // BENNER - SMS 1438904
    ...
    updateWidget: function() {
      ...
      var hour = this.hour.toString().length === 1 ? '0' + this.hour : this.hour, // BENNER
